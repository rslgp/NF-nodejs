...
const NFSeStrategy = require("../interface/NFSeStrategy");

let instance = null;

class NF_PlugNotas extends NFSeStrategy {
	constructor() {
		super();
		if (!instance) {
			instance = this;
	...
	registrarNF(
		api_endpoint_path,
		payloadDataMultiplasNotasJSONArray = mock.MOCK_payloadDataMultiplasNFeJSONArray
	) {
...
module.exports = new NF_PlugNotas();
